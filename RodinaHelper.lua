...
imgui.OnFrame(
    ...
    function(self)
        ...
        if imgui.Begin('##Update', _, imgui.WindowFlags.NoTitleBar + imgui.WindowFlags.NoScrollbar) then
            ...
            imgui.PopFont()
            imgui.Text(u8'Дата 14.12.23')
            imgui.Text(u8'Версия: 1.1')
            imgui.Text(u8'Изменения:')
            imgui.BeginChild('##updatelist', imgui.ImVec2(-1, 230), true, imgui.WindowFlags.NoScrollbar)
            imgui.Text(u8'бла бла бла\nбла бла бла\nбла бла бла\nбла бла бла\nбла бла бла\nбла бла бла\nбла бла бла\nбла бла бла\nбла бла бла\nбла бла бла\nбла бла бла\nбла бла бла\nбла бла бла\nбла бла бла\nбла бла бла\nбла бла бла\nбла бла бла\nбла бла бла\n')
            imgui.EndChild()
            imgui.SetCursorPosY(imgui.GetWindowSize().y-40)
            imgui.Button(u8'Установить', imgui.ImVec2(187,35))
            imgui.SameLine()
            imgui.Button(u8'Пропустить', imgui.ImVec2(187,35))
            imgui.EndChild()
            imgui.End()
            imgui.PopStyleVar()
        end

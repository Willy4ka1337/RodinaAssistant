...
imgui.OnFrame(
    ...
    function(self)
        ...
        if imgui.Begin('##Update', _, imgui.WindowFlags.NoTitleBar + imgui.WindowFlags.NoScrollbar) then
            ...
            imgui.PopFont()
            imgui.Text(u8'Äàòà 14.12.23')
            imgui.Text(u8'Âåðñèÿ: 1.1')
            imgui.Text(u8'Èçìåíåíèÿ:')
            imgui.BeginChild('##updatelist', imgui.ImVec2(-1, 230), true, imgui.WindowFlags.NoScrollbar)
            imgui.Text(u8'áëà áëà áëà\náëà áëà áëà\náëà áëà áëà\náëà áëà áëà\náëà áëà áëà\náëà áëà áëà\náëà áëà áëà\náëà áëà áëà\náëà áëà áëà\náëà áëà áëà\náëà áëà áëà\náëà áëà áëà\náëà áëà áëà\náëà áëà áëà\náëà áëà áëà\náëà áëà áëà\náëà áëà áëà\náëà áëà áëà\n')
            imgui.EndChild()
            imgui.SetCursorPosY(imgui.GetWindowSize().y-40)
            imgui.Button(u8'Óñòàíîâèòü', imgui.ImVec2(187,35))
            imgui.SameLine()
            imgui.Button(u8'Ïðîïóñòèòü', imgui.ImVec2(187,35))
            imgui.EndChild()
            imgui.End()
            imgui.PopStyleVar()
        end
